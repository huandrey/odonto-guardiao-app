    ...
    <div className="modal-overlay">
      <div className="modal-container">
        ...
        <div className="privacy-notice">
          ...
          A identificação do CRO é necessária apenas para garantir que a área de realização 
          de denúncia seja disponibilizada exclusivamente para profissionais cadastrados.
        </div>
